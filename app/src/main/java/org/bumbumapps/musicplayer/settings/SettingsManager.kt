...
import org.bumbumapps.musicplayer.home.tabs.Tab
...
class SettingsManager private constructor(context: Context) :
    ...
    val addAudios: Boolean
        get() = sharedPrefs.getBoolean(KEY_ADD_AUDIO, false)
    ...
    /** Whether [org.bumbumapps.musicplayer.playback.state.LoopMode.TRACK] should pause when the track repeats */
