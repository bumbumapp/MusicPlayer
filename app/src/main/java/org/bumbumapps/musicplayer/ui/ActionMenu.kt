...
class ActionMenu(
    ...
    companion object {
        ...
        /** Flag for when a menu is opened from an artist (See [org.bumbumapps.musicplayer.detail.ArtistDetailFragment]) **/
        const val FLAG_IN_ARTIST = 0
        /** Flag for when a menu is opened from an album (See [org.bumbumapps.musicplayer.detail.AlbumDetailFragment]) **/
        const val FLAG_IN_ALBUM = 1
        /** Flag for when a menu is opened from a genre (See [org.bumbumapps.musicplayer.detail.GenreDetailFragment]) **/
