...
package org.bumbumapps.musicplayer.playback.state
...
import org.bumbumapps.musicplayer.music.MusicParent
 ...
 * - If you want to use the playback state in the UI, use [org.bumbumapps.musicplayer.playback.PlaybackViewModel] as it can withstand volatile UIs.
 * - If you want to use the playback state with the ExoPlayer instance or system-side things, use [org.bumbumapps.musicplayer.playback.system.PlaybackService].
 *
